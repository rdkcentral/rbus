...
#### [v2.14.0](https://github.com/rdkcentral/rbus/compare/v2.13.0...v2.14.0)

- RDK-61800: Enable Cross-Path Trace Context Propagation [`#454`](https://github.com/rdkcentral/rbus/pull/454)
- RDKDEV-1444, RDKBDEV-3389 Add Documentation RBus [`#450`](https://github.com/rdkcentral/rbus/pull/450)

#### [v2.13.0](https://github.com/rdkcentral/rbus/compare/v2.12.0...v2.13.0)

> 22 July 2026

- XB10-2715: Avoid redundant tableSyncHandler calls during wildcard get resolution [`#449`](https://github.com/rdkcentral/rbus/pull/449)
- Release of v2.13.0 [`3ee1b58`](https://github.com/rdkcentral/rbus/commit/3ee1b58fd8d1f71b0fa824e55bb5182276f6e59c)

#### [v2.12.0](https://github.com/rdkcentral/rbus/compare/v2.11.0...v2.12.0)

> 3 March 2026

- Update code for better readability [`#443`](https://github.com/rdkcentral/rbus/pull/443)
- RDK-60607: Fix for y2k38 issue and integer overflow [`#442`](https://github.com/rdkcentral/rbus/pull/442)
- RDK-60607: Data race condition,rtSemaphore_TimedWait [`#439`](https://github.com/rdkcentral/rbus/pull/439)
- RDK-60607: (cid:559883) Data race condition, rtConnection_CallbackThread [`#440`](https://github.com/rdkcentral/rbus/pull/440)
- RDK-60607: (cid:278291)  Unchecked return value, rtThreadPool_StopAll… [`#436`](https://github.com/rdkcentral/rbus/pull/436)
- RDK-60607: Coverity fix in rtmessage [`#434`](https://github.com/rdkcentral/rbus/pull/434)
- RDK-60409: Component independent Tool Development for Noisy Log detection [`#433`](https://github.com/rdkcentral/rbus/pull/433)
- rtmessage: add null checks for arguments in rtMessageHeader_Decode [`#383`](https://github.com/rdkcentral/rbus/pull/383)
- Release of v2.12.0 [`3e34454`](https://github.com/rdkcentral/rbus/commit/3e344546469f2ac2daf4314ff6acc7ca718580f6)

#### [v2.11.0](https://github.com/rdkcentral/rbus/compare/v2.10.0...v2.11.0)

> 23 December 2025

- RDKB-59800 : Handle the subscription of event upon crash recovery [`#429`](https://github.com/rdkcentral/rbus/pull/429)
- rbuscli: fixup unreachable code in hints function [`#388`](https://github.com/rdkcentral/rbus/pull/388)
- RDKB-62669 : rbus build failure with TEST DISTRO [`#390`](https://github.com/rdkcentral/rbus/pull/390)
- rbus: prevent overflow when reading timeouts [`#375`](https://github.com/rdkcentral/rbus/pull/375)
- Revert "RDKB-62423 : Use CLOCK_MONOTONIC_RAW across rbus (#379)" [`#416`](https://github.com/rdkcentral/rbus/pull/416)
- rbus: fixup unreachable code in rbus_open [`#387`](https://github.com/rdkcentral/rbus/pull/387)
- rbus_message: ensure lock release in RemoveAllListeners [`#377`](https://github.com/rdkcentral/rbus/pull/377)
- rbus: check return value of remove [`#376`](https://github.com/rdkcentral/rbus/pull/376)
- rbus: fixup null pointer dereference in _subscribe_async_callback_handler [`#382`](https://github.com/rdkcentral/rbus/pull/382)
- rtrouted: check mkdir return value [`#374`](https://github.com/rdkcentral/rbus/pull/374)
- rbus: check for null pointer in ValueChangeRecord [`#372`](https://github.com/rdkcentral/rbus/pull/372)
- rtrouted: fixup null dereference in ReadTextFile [`#371`](https://github.com/rdkcentral/rbus/pull/371)
- rbus: fixup null dereference in SubscribeRawData [`#370`](https://github.com/rdkcentral/rbus/pull/370)
- rtHashMap: fixup divide by zero in Hash_Func_String [`#369`](https://github.com/rdkcentral/rbus/pull/369)
- Release of v2.11.0 [`45f5d1e`](https://github.com/rdkcentral/rbus/commit/45f5d1e40d2596b50634f89a2037aaaedb1291d0)

#### [v2.10.0](https://github.com/rdkcentral/rbus/compare/v2.9.0...v2.10.0)

> 13 November 2025

- Fixed race condition in rtRetainable reference counting [`#380`](https://github.com/rdkcentral/rbus/pull/380)
- RDKB-62423 : Use CLOCK_MONOTONIC_RAW across rbus [`#379`](https://github.com/rdkcentral/rbus/pull/379)
- RDKB-62297: Unchecked return value from library rtrouted.c [`#373`](https://github.com/rdkcentral/rbus/pull/373)
- Deploy cla action [`#367`](https://github.com/rdkcentral/rbus/pull/367)
- Release of v2.10.0 [`976d570`](https://github.com/rdkcentral/rbus/commit/976d570993fc0e7abd2422872cd0dd8b8e838b1e)
...
- Release of v2.9.0 [`2f82b00`](https://github.com/rdkcentral/rbus/commit/2f82b00b264673a42a9c878a6d10b82a37cbdfab)
