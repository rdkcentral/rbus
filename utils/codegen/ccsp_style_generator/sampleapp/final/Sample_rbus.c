...
void* WritableTable2_AddEntry(void* ctx, uint32_t* instNum)
{
    int index;
    writableRecordCount = Hal_AddWritableRecord();
    index = writableRecordCount-1;
...
static rbusError_t WritableTable2_AddEntry_rbus(rbusHandle_t handle, char const* tableName, char const* aliasName, uint32_t* instNum)
{
    uint32_t setInst = 0;
    ...
    *instNum = setInst+1;
    ...
    void* rowContext = WritableTable2_AddEntry(context.userData, instNum);
    if(!rowContext)
    {
        rtLog_Error("WritableTable2_AddEntry returned null row context");
        return RBUS_ERROR_BUS_ERROR;
    }
...
rbusError_t WritableTable2_DelEntry(void* ctx, void* inst)
{
    return RBUS_ERROR_SUCCESS;
}

static rbusError_t WritableTable2_DelEntry_rbus(rbusHandle_t handle, char const* rowName)
{
    HandlerContext context = GetHandlerContext(rowName);
    void* rowContext = GetRowContext(context.fullName);
    int rc = WritableTable2_DelEntry(context.userData, rowContext);
    if(rc != RBUS_ERROR_SUCCESS)
    {
        rtLog_Error("WritableTable2_DelEntry failed");
        return RBUS_ERROR_BUS_ERROR;
    }
...
static rbusError_t WritableTable2_GetParamBoolValue_rbus(rbusHandle_t handle, rbusProperty_t property, rbusGetHandlerOptions_t* opts)
{
    HandlerContext context = GetPropertyContext(property);
    DmlWritableRecord* record = (DmlWritableRecord*)context.userData;
    if(!record)
    ...
    if(strcmp(context.name, "BoolParam2") == 0)
    {
        rbusProperty_SetBoolean(property, record->halData.boolVal);
    }
    else
    {
        rtLog_Error("WritableTable2_GetParamBoolValue_rbus failed");
        return RBUS_ERROR_INVALID_INPUT;
    }
...
static rbusError_t WritableTable2_GetParamIntValue_rbus(rbusHandle_t handle, rbusProperty_t property, rbusGetHandlerOptions_t* opts)
{
    HandlerContext context = GetPropertyContext(property);
    DmlWritableRecord* record = (DmlWritableRecord*)context.userData;
    if(!record)
    ...
    if(strcmp(context.name, "IntParam2") == 0)
    {
        rbusProperty_SetInt32(property, record->halData.intVal);
    }
    else
    {
        rtLog_Error("WritableTable2_GetParamIntValue_rbus failed");
        return RBUS_ERROR_INVALID_INPUT;
    }
...
static rbusError_t WritableTable2_GetParamUlongValue_rbus(rbusHandle_t handle, rbusProperty_t property, rbusGetHandlerOptions_t* opts)
{
    HandlerContext context = GetPropertyContext(property);
    DmlWritableRecord* record = (DmlWritableRecord*)context.userData;
    if(!record)
    ...
    if(strcmp(context.name, "UlongParam2") == 0)
    {
        rbusProperty_SetUInt32(property, record->halData.ulongVal);
    }
    else
    {
        rtLog_Error("WritableTable2_GetParamUlongValue_rbus failed");
        return RBUS_ERROR_INVALID_INPUT;
    }
...
static rbusError_t WritableTable2_GetParamStringValue_rbus(rbusHandle_t handle, rbusProperty_t property, rbusGetHandlerOptions_t* opts)
{
    HandlerContext context = GetPropertyContext(property);
    DmlWritableRecord* record = (DmlWritableRecord*)context.userData;
    if(!record)
    ...
    if(strcmp(context.name, "StringParam2") == 0)
    {
        rbusProperty_SetString(property, record->halData.stringVal);
    }
    else
    {
        rtLog_Error("WritableTable2_GetParamStringValue_rbus failed");
        return RBUS_ERROR_INVALID_INPUT;
    }
...
rbusError_t do_WritableTable2_Validate_WritableTable2_Commit_WritableTable2_Rollback(void* context)
{
    if(WritableTable2_Validate(context) == 0)
    {
        if(WritableTable2_Commit(context) == 0)
            return RBUS_ERROR_SUCCESS;
        else
            return RBUS_ERROR_BUS_ERROR;
    }
    ...
    {
        if(WritableTable2_Rollback(context) == 0)
            return RBUS_ERROR_INVALID_INPUT;
        else
            return RBUS_ERROR_BUS_ERROR;  
    }
...
rbusError_t WritableTable2_SetParamBoolValue_rbus(rbusHandle_t handle, rbusProperty_t property, rbusSetHandlerOptions_t* opts)
{
    HandlerContext context = GetPropertyContext(property);
    DmlWritableRecord* record = (DmlWritableRecord*)context.userData;
    if(!record)
    ...
    {
        rtLog_Error("WritableTable2_SetParamBoolValue_rbus failed");
        return RBUS_ERROR_INVALID_INPUT;
    }
...
rbusError_t WritableTable2_SetParamIntValue_rbus(rbusHandle_t handle, rbusProperty_t property, rbusSetHandlerOptions_t* opts)
{
    HandlerContext context = GetPropertyContext(property);
    DmlWritableRecord* record = (DmlWritableRecord*)context.userData;
    if(!record)
    ...
    {
        rtLog_Error("WritableTable2_SetParamIntValue_rbus failed");
        return RBUS_ERROR_INVALID_INPUT;
    }
...
rbusError_t WritableTable2_SetParamUlongValue_rbus(rbusHandle_t handle, rbusProperty_t property, rbusSetHandlerOptions_t* opts)
{
    HandlerContext context = GetPropertyContext(property);
    DmlWritableRecord* record = (DmlWritableRecord*)context.userData;
    if(!record)
    ...
    {
        rtLog_Error("WritableTable2_SetParamUlongValue_rbus failed");
        return RBUS_ERROR_INVALID_INPUT;
    }
...
rbusError_t WritableTable2_SetParamStringValue_rbus(rbusHandle_t handle, rbusProperty_t property, rbusSetHandlerOptions_t* opts)
{
    HandlerContext context = GetPropertyContext(property);
    DmlWritableRecord* record = (DmlWritableRecord*)context.userData;
    if(!record)
    ...
    {
        rtLog_Error("WritableTable2_SetParamStringValue_rbus failed");
        return RBUS_ERROR_INVALID_INPUT;
    }
...
rbusError_t registerGeneratedDataElements(rbusHandle_t handle)
{
    ...
    static rbusDataElement_t dataElements[30] = {
        ...
        {"Device.Sample.WritableTable.{i}.WritableTable2.{i}.", RBUS_ELEMENT_TYPE_TABLE, {NULL, NULL, WritableTable2_AddEntry_rbus, WritableTable2_DelEntry_rbus, NULL, NULL}},
        {"Device.Sample.WritableTable.{i}.WritableTable2.{i}.BoolParam2", RBUS_ELEMENT_TYPE_PROPERTY, {WritableTable2_GetParamBoolValue_rbus, WritableTable2_SetParamBoolValue_rbus, NULL, NULL, NULL, NULL}},
